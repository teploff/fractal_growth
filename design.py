...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.l_single_phase_count_iter = QtWidgets.QLabel(self.groupBox_2)
        self.l_single_phase_count_iter.setTextFormat(QtCore.Qt.AutoText)
        self.l_single_phase_count_iter.setAlignment(QtCore.Qt.AlignCenter)
        self.l_single_phase_count_iter.setObjectName("l_single_phase_count_iter")
        self.horizontalLayout_10.addWidget(self.l_single_phase_count_iter)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_10.addItem(spacerItem3)
        self.sb_single_phase_count_iter = QtWidgets.QSpinBox(self.groupBox_2)
        self.sb_single_phase_count_iter.setAlignment(QtCore.Qt.AlignCenter)
        self.sb_single_phase_count_iter.setMinimum(1)
        self.sb_single_phase_count_iter.setMaximum(200)
        self.sb_single_phase_count_iter.setSingleStep(5)
        self.sb_single_phase_count_iter.setProperty("value", 40)
        self.sb_single_phase_count_iter.setObjectName("sb_single_phase_count_iter")
        self.horizontalLayout_10.addWidget(self.sb_single_phase_count_iter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.l_single_phase_count_iter.setText(_translate("MainWindow", "Количество итераций"))
